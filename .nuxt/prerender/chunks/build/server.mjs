import { hasInjectionContext, getCurrentInstance, version, ref, watchEffect, watch, inject, toRef, onServerPrefetch, isRef, defineAsyncComponent, computed, useSSRContext, unref, h, defineComponent, resolveComponent, shallowRef, shallowReactive, reactive, mergeProps, createVNode, resolveDynamicComponent, withCtx, renderSlot, withAsyncContext, openBlock, createBlock, createCommentVNode, toDisplayString, Fragment, createTextVNode, readonly, nextTick, renderList, createApp, getCurrentScope, onScopeDispose, provide, onErrorCaptured, isReadonly, isShallow, isReactive, toRaw, createElementBlock, Suspense, Transition } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/vue/index.mjs';
import { $fetch as $fetch$1 } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/ofetch/dist/node.mjs';
import { createHooks } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/unctx/dist/index.mjs';
import destr from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/destr/dist/index.mjs';
import { klona } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/klona/dist/index.mjs';
import { getActiveHead } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin, composableNames } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/@unhead/shared/dist/index.mjs';
import { createMemoryHistory, createRouter, START_LOCATION, RouterView } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/vue-router/dist/vue-router.node.mjs';
import { createError as createError$1, getRequestHeader, setCookie, getCookie, deleteCookie, sanitizeStatusCode } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/h3/dist/index.mjs';
import { withoutTrailingSlash, withLeadingSlash, joinURL, hasProtocol, parseURL, parseQuery, withBase, withTrailingSlash, withQuery, isScriptProtocol } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/ufo/dist/index.mjs';
import { hash, isEqual } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/ohash/dist/index.mjs';
import { parse } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/cookie-es/dist/index.mjs';
import { nanoid } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/nanoid/index.js';
import { kebabCase } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/scule/dist/index.mjs';
import { defu } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/defu/dist/defu.mjs';
import { ssrRenderAttrs, ssrRenderVNode, ssrRenderSlot, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrRenderTeleport, ssrRenderAttr, ssrRenderSuspense } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/vue/server-renderer/index.mjs';
import { Icon as Icon$1 } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/@iconify/vue/dist/offline.mjs';
import { loadIcon } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/@iconify/vue/dist/iconify.mjs';
import { useFuse } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/@vueuse/integrations/useFuse.mjs';
import { useFocusTrap } from 'file:///Users/yong/Data/Project-AI/Fashion/Git/docs/docs/node_modules/@vueuse/integrations/useFocusTrap.mjs';
import { b as useRuntimeConfig$1 } from '../runtime.mjs';
...
const __nuxt_component_0$6 = /* @__PURE__ */ defineNuxtLink({ componentName: "NuxtLink" });
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./document-driven-f665120b.mjs').then((m) => m.default || m)
  }
];
...
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import('./DocumentDrivenNotFound-b773ef52.mjs').then((r) => r.default));
const LazyEllipsis = defineAsyncComponent(() => import('./Ellipsis-ea6fb302.mjs').then((r) => r.default));
const LazyThemeSelect = defineAsyncComponent(() => Promise.resolve().then(function() {
  return ThemeSelect;
}).then((r) => r.default));
const LazyDocsAside = defineAsyncComponent(() => import('./DocsAside-3d9d5d7e.mjs').then((r) => r.default));
const LazyDocsAsideTree = defineAsyncComponent(() => Promise.resolve().then(function() {
  return DocsAsideTree;
}).then((r) => r.default));
const LazyDocsPageBottom = defineAsyncComponent(() => import('./DocsPageBottom-32fb3073.mjs').then((r) => r.default));
const LazyDocsPageLayout = defineAsyncComponent(() => import('./DocsPageLayout-a65f7dde.mjs').then((r) => r.default));
const LazyDocsPrevNext = defineAsyncComponent(() => import('./DocsPrevNext-00b6f72e.mjs').then((r) => r.default));
const LazyDocsToc = defineAsyncComponent(() => import('./DocsToc-2ade1f30.mjs').then((r) => r.default));
const LazyDocsTocLinks = defineAsyncComponent(() => import('./DocsTocLinks-f81acaaa.mjs').then((r) => r.default));
const LazyEditOnLink = defineAsyncComponent(() => import('./EditOnLink-6d4bec13.mjs').then((r) => r.default));
const LazySourceLink = defineAsyncComponent(() => import('./SourceLink-5dc6382d.mjs').then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-46d71287.mjs').then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-c018c9e9.mjs').then((r) => r.default));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-1add13be.mjs').then((r) => r.default));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-717bc325.mjs').then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-6c981ec6.mjs').then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-a0c07055.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-87e770f0.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-5bdc6715.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-36c2d55e.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-0d291915.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-fe8c522c.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-2a113a3c.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-adb19cc3.mjs').then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-7c6f3a78.mjs').then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-a4b6a08d.mjs').then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-2970ab9f.mjs').then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-b86bd462.mjs').then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-d3f76af3.mjs').then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-741e49c5.mjs').then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-48c4da25.mjs').then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-7483970a.mjs').then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-f87667b0.mjs').then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-da4c5888.mjs').then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-695f845c.mjs').then((r) => r.default));
const LazyAlert = defineAsyncComponent(() => import('./Alert-3dd92133.mjs').then((r) => r.default));
const LazyBadge = defineAsyncComponent(() => import('./Badge-c9102010.mjs').then((r) => r.default));
const LazyButtonLink = defineAsyncComponent(() => import('./ButtonLink-890a02df.mjs').then((r) => r.default));
const LazyCallout = defineAsyncComponent(() => import('./Callout-a113fc03.mjs').then((r) => r.default));
const LazyCodeBlock = defineAsyncComponent(() => import('./CodeBlock-59930be8.mjs').then((r) => r.default));
const LazyCodeGroup = defineAsyncComponent(() => import('./CodeGroup-e4f938b1.mjs').then((r) => r.default));
const LazyContainer = defineAsyncComponent(() => Promise.resolve().then(function() {
  return Container;
}).then((r) => r.default));
const LazyCopyButton = defineAsyncComponent(() => import('./CopyButton-0733fe66.mjs').then((r) => r.default));
const LazyList = defineAsyncComponent(() => import('./List-ec04376c.mjs').then((r) => r.default));
const LazyNuxtImg = defineAsyncComponent(() => import('./NuxtImg-6dc0a077.mjs').then((r) => r.default));
const LazyProps = defineAsyncComponent(() => import('./Props-eac087aa.mjs').then((r) => r.default));
const LazySandbox = defineAsyncComponent(() => import('./Sandbox-e7080dff.mjs').then((r) => r.default));
const LazyTabsHeader = defineAsyncComponent(() => import('./TabsHeader-406999f7.mjs').then((r) => r.default));
const LazyTerminal = defineAsyncComponent(() => import('./Terminal-948cdef0.mjs').then((r) => r.default));
const LazyVideoPlayer = defineAsyncComponent(() => import('./VideoPlayer-c4ae1337.mjs').then((r) => r.default));
const LazyIconCodeSandBox = defineAsyncComponent(() => import('./IconCodeSandBox-d1f205ab.mjs').then((r) => r.default));
const LazyIconDocus = defineAsyncComponent(() => import('./IconDocus-d8288831.mjs').then((r) => r.default));
const LazyIconNuxt = defineAsyncComponent(() => import('./IconNuxt-d7e952ad.mjs').then((r) => r.default));
const LazyIconNuxtContent = defineAsyncComponent(() => import('./IconNuxtContent-3f799b68.mjs').then((r) => r.default));
const LazyIconNuxtLabs = defineAsyncComponent(() => import('./IconNuxtLabs-99fe096f.mjs').then((r) => r.default));
const LazyIconNuxtStudio = defineAsyncComponent(() => import('./IconNuxtStudio-4962a352.mjs').then((r) => r.default));
const LazyIconStackBlitz = defineAsyncComponent(() => import('./IconStackBlitz-eb645fca.mjs').then((r) => r.default));
const LazyIconVueTelescope = defineAsyncComponent(() => import('./IconVueTelescope-da88adfe.mjs').then((r) => r.default));
const LazyBlockHero = defineAsyncComponent(() => import('./BlockHero-cfe4c5fb.mjs').then((r) => r.default));
const LazyCard = defineAsyncComponent(() => import('./Card-13d2b49b.mjs').then((r) => r.default));
const LazyCardGrid = defineAsyncComponent(() => import('./CardGrid-5db78e1e.mjs').then((r) => r.default));
const LazyVoltaBoard = defineAsyncComponent(() => import('./VoltaBoard-98820156.mjs').then((r) => r.default));
const LazyComponentPlayground = defineAsyncComponent(() => import('./ComponentPlayground-5a08eeba.mjs').then((r) => r.default));
const LazyComponentPlaygroundData = defineAsyncComponent(() => import('./ComponentPlaygroundData-9faf9d8a.mjs').then((r) => r.default));
const LazyComponentPlaygroundProps = defineAsyncComponent(() => import('./ComponentPlaygroundProps-0bc66b6a.mjs').then((r) => r.default));
const LazyComponentPlaygroundSlots = defineAsyncComponent(() => import('./ComponentPlaygroundSlots-0dbd767a.mjs').then((r) => r.default));
const LazyComponentPlaygroundTokens = defineAsyncComponent(() => import('./ComponentPlaygroundTokens-548a0a2d.mjs').then((r) => r.default));
const LazyPreviewLayout = defineAsyncComponent(() => import('./PreviewLayout-edb688dc.mjs').then((r) => r.default));
const LazyTokensPlayground = defineAsyncComponent(() => import('./TokensPlayground-c79c912f.mjs').then((r) => r.default));
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-e047e66c.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-a725ea81.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-b15b893f.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-533cb547.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-7bcaad80.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-c22b6bc7.mjs').then((r) => r.default));
const LazyContentSlot = defineAsyncComponent(() => import('./ContentSlot-8ddc8cc2.mjs').then((r) => r.default));
const LazyDocumentDrivenEmpty = defineAsyncComponent(() => import('./DocumentDrivenEmpty-e7fcdb87.mjs').then((r) => r.default));
const LazyMarkdown = defineAsyncComponent(() => import('./Markdown-5e6ffda7.mjs').then((r) => r.default));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-b25fe3d4.mjs').then((r) => r.default));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-be792c9d.mjs').then((r) => r.default));
const LazyIcon = defineAsyncComponent(() => Promise.resolve().then(function() {
  return Icon;
}).then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-bbd622de.mjs').then((r) => r.default));
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-62547f95.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-62547f95.mjs').then((m) => m.generateNavigation);
...
const layouts = {
  default: () => import('./default-ef8dbdfe.mjs').then((m) => m.default || m),
  page: () => import('./page-9199cc54.mjs').then((m) => m.default || m)
};
...
const _imports_0 = "" + __publicAssetsURL("static/DeepFashion.svg");
const _sfc_main$c = {};
...
const __nuxt_component_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["ssrRender", _sfc_ssrRender$2]]);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./error-404-ecf3e632.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./error-500-2cb12bce.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./island-renderer-325ff9dc.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { useColorMode as A, usePinceauTheme as B, queryContent as C, fetchContentNavigation as D, get$1 as E, assertArray as F, ensureArray as G, omit as H, sortList as I, apply as J, withoutKeys as K, LayoutMetaSymbol as L, withKeys as M, createQuery as N, PageRouteSymbol as P, _export_sfc as _, __nuxt_component_0$6 as a, useRoute as b, createError as c, appLayoutTransition as d, entry$1 as default, _wrapIf as e, useNuxtApp as f, useRuntimeConfig as g, useContent as h, useRequestEvent as i, useContentHead as j, usePinceauRuntime as k, layouts as l, useContentPreview as m, computedStyle as n, __nuxt_component_0$4 as o, useDocus as p, __nuxt_component_0$3 as q, useAppConfig as r, useState as s, __nuxt_component_0$5 as t, useHead as u, useContentHelpers as v, useRouter as w, useClipboard as x, onClickOutside as y, useAsyncData as z };
