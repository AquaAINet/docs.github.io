...
import {
  kebabCase
} from "./chunk-K26BKXHQ.js";
import "./chunk-ZC22LKFR.js";

// node_modules/pinceau/node_modules/nanoid/index.browser.js
...
var plugin = {
  install(app, options) {
    ...
    if (dev && (import.meta.hot || process.server)) {
      import("./debug-ZP5YNCCY.js").then(({ usePinceauRuntimeDebug }) => usePinceauRuntimeDebug(tokensHelperConfig));
    }
